...
def main():
    ...
    ap.add_argument('--ply', default='../output/garden_fused_table_repaired/point_cloud/iteration_30000/point_cloud.ply')
    ap.add_argument('--info', default='../output/garden_fused_table_repaired/fusion_info.txt')
    ap.add_argument('--out-dir', default='../output/garden_fused_table_repaired/official_3dgs_walkthrough')
    ...
    video_path = out_dir / 'task1_scene_fusion_table_repaired_3dgs.mp4'
    ...
    if previews:
        ...
        sheet.save(out_dir / 'task1_scene_fusion_table_repaired_3dgs_preview.png')

    print(f'video: {video_path}')
    print(f'preview: {out_dir / "task1_scene_fusion_table_repaired_3dgs_preview.png"}')
