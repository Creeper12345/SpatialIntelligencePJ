...
def main():
    ...
    ap.add_argument('--ply', default='../output/garden/point_cloud/iteration_30000/point_cloud.ply')
    ap.add_argument('--info', default='../output/garden_fused_table/fusion_info.txt')
    ap.add_argument('--out-dir', default='../output/garden_table_bg_3dgs')
    ...
    video_path = out_dir / 'garden_table_bg_3dgs.mp4'
    ...
    if previews:
        ...
        sheet.save(out_dir / 'garden_table_bg_3dgs_preview.png')

    print(f'video: {video_path}')
    print(f'preview: {out_dir / "garden_table_bg_3dgs_preview.png"}')
